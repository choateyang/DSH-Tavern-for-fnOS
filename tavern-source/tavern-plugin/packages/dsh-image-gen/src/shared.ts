...
/** Supported providers. */
export const IMAGE_PROVIDERS = ['google', 'openai', 'seedream', 'dashscope', 'grok', 'comfyui'] as const
export type ImageProvider = typeof IMAGE_PROVIDERS[number]

/** Providers supported by the first browser workbench release. */
export const CLOUD_IMAGE_PROVIDERS = ['google', 'openai', 'seedream', 'dashscope', 'grok'] as const
